...
CREATE TABLE IF NOT EXISTS `hellow_eventos`.`fk_ingresso_cliente` (
  ...
  PRIMARY KEY (`cliente_id`, `ingresso_id`),
  INDEX `fk_cliente_has_ingresso_ingresso1_idx` (`ingresso_id` ASC) ,
  INDEX `fk_cliente_has_ingresso_cliente_idx` (`cliente_id` ASC) ,
